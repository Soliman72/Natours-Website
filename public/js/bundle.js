      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'you are logged in success!');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'you are Sign Up success!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'your data updated successfuly');
          }
          ;
          _context.next = 13;
          break;
...
var userFormSetting = document.querySelector('.form-user-settings');
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            email = document.getElementById('email').value; // const photo =  document.getElementById( 'photo' ).files[ 0 ] ;
            _context.next = 6;
...
if (userFormSetting) {
  userFormSetting.addEventListener('submit', /*#__PURE__*/function () {
